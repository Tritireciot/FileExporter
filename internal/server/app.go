...
func (app *App) InitializeRouter(db_repo *db.DBRepository, transformer_ *transformer.TransformService) {
...
func (app *App) Init(db_repo *db.DBRepository, transformer_ *transformer.TransformService) {
